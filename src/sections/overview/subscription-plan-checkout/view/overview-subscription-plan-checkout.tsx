        ...
        <Grid item xs={12} md={6}>
          <Paper elevation={10} sx={{ padding: '20px', borderRadius: '12px' }}>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between">
              <Typography variant="subtitle1" sx={{ opacity: 0.6, fontSize: '1rem' }}>
                {' '}
                Plan Name{' '}
              </Typography>
            ...
            <Stack mt="15px" direction="row" alignItems="center" justifyContent="space-between">
              ...
              <Typography variant="subtitle1" color="error" sx={{ fontSize: '1rem' }}>
                {' '}
                - 20 KWD
              </Typography>
            </Stack>
        ...
        content={
          <Box textAlign="center">
            ...
            <Typography
              component="p"
              variant="h4"
              sx={{ maxWidth: '300px', marginX: 'auto', mt: '26px' }}
            >
              Payment Successful!
            </Typography>
            ...
            <Box mt="20px">
              <Linker path={paths.dashboard.root} width="100%">
                <Button
                  variant="contained"
                  size="large"
                  color="primary"
