...
export default function AccountView() {
  ...
  const handleChangeDropDown =
    (changeTo?: string | undefined | null) => (event: SelectChangeEvent) => {
      if (changeTo === 'currency') setCurrency(event.target.value as string);
      else if (changeTo === 'gov')
        setDropDown((pv) => ({ ...pv, government: event.target.value as string }));
      else if (changeTo === 'dfee')
        setDropDown((pv) => ({ ...pv, dfee: event.target.value as string }));
      else if (changeTo === 'mo')
        setDropDown((pv) => ({ ...pv, mo: event.target.value as string }));
      else if (changeTo === 'dt')
        setDropDown((pv) => ({ ...pv, dt: event.target.value as string }));
      else if (changeTo === 'zone')
        setDropDown((pv) => ({ ...pv, zone: event.target.value as string }));
    };
  ...
  const detailsSchema = Yup.object().shape({
    branchNameEng: Yup.string().required('Branch name is required'),
    branchNameArab: Yup.string().required('Branch name is required'),
    ...
    <Box>
              ...
              <Box sx={{ maxWidth: '700px', width: '100%' }}>
                ...
                >
                  <Grid xs={12} md={6}>
                    ...
                    <RHFTextField fullWidth variant="filled" name="branchNameEng" />
                  </Grid>
                  <Grid xs={12} md={6}>
                    <Typography
                      component="p"
                    ...
                    <RHFTextField fullWidth variant="filled" name="branchNameArab" />
                  </Grid>
              ...
              >
                ...
                <Grid xs={12} md={6}>
                  ...
                  <TextField
                    fullWidth
                    variant="filled"
                    defaultValue="Kuwait, Al Nuzha, 502 street"
                    name="Main Branch"
                  />
                </Grid>
                <Grid xs={12} md={6}>
                  ...
                  <TextField
                    fullWidth
                    variant="filled"
                    defaultValue="الكويت, النزهة, 502 شارع"
                    name="Main Branch"
                  />
                </Grid>
              </Grid>
      ...
      >
        ...
        <Box width="100%">
          ...
          <FormControl fullWidth>
            <Select variant="filled" value={dropDown.zone} onChange={handleChangeDropDown('zone')}>
          ...
          <Grid container alignItems="center" justifyContent="space-between" spacing="10px">
            <Grid xs={12} sm={6}>
              ...
              <TextField variant="filled" fullWidth defaultValue="5 KWD" />
            </Grid>
            <Grid xs={12} sm={6}>
              <Typography
                mt="20px"
              ...
              <TextField variant="filled" fullWidth defaultValue="20 KWD" />
            </Grid>
          </Grid>
          ...
          <FormControl fullWidth>
            <Select variant="filled" value={dropDown.dt} onChange={handleChangeDropDown('dt')}>
...
const ShowTimerDialog = ({ index, prevData, property, updateWorkingHours, closeDialog }: any) => {
  ...
  return (
    <Dialog maxWidth="xs" open={openTime}>
      ...
      <DialogContent>
        <TimePicker onChange={(e) => setSelectedTime(e)} />
      </DialogContent>
      <DialogActions>
