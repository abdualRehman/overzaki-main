    ...
    <div>
      <Box pt="20px">
        <RadioGroup
          ...
          onChange={(event) =>
            handleThemeConfig('layout.homePage.product.rowType', event.target.value, 'layout')
          }
          sx={{
            display: 'flex',
        ...
        >
          <FormControlLabel
            value="1"
            control={
              <Radio checked={themeConfig.layout.homePage.product.rowType === '1'} size="medium" />
            }
            label={
          ...
          <FormControlLabel
            value="2"
            control={
              <Radio checked={themeConfig.layout.homePage.product.rowType === '2'} size="medium" />
            }
            label={
              <Stack direction="row" alignItems="center" spacing="12px" ml="15px">
          ...
          <FormControlLabel
            value="3"
            control={
              <Radio checked={themeConfig.layout.homePage.product.rowType === '3'} size="medium" />
            }
            label={
              <Stack direction="row" alignItems="center" spacing="12px" ml="15px">
          ...
          {/* <FormControlLabel
            value="6"
            control={<Radio checked={themeConfig?.productPageView === '6'} size="medium" />}
            label={
              <Stack direction="row" alignItems="center" spacing="12px" ml="15px">
                <Box component="img" src="/raws/Grid1.png" />
                <Typography variant="caption" component="p" color="#0F1349">
          ...
          <FormControlLabel
            value="12"
            control={<Radio checked={themeConfig?.productPageView === '12'} size="medium" />}
            label={
              <Stack direction="row" alignItems="center" spacing="12px" ml="15px">
                <Box component="img" src="/raws/Grid3.png" />
                <Typography variant="caption" component="p" color="#0F1349">
