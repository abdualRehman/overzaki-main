...
import { TextField, Typography, Box, RadioGroup, FormControlLabel, Radio, Stack, Tabs, Tab, Slider, Accordion, AccordionSummary, AccordionDetails, Divider, Switch, IconButton } from '@mui/material';
    ...
    return (
        <div>
            ...
            <Stack spacing={1} sx={{
                ...
                <Accordion sx={{
                    width: "100%", '& .css-55bqac-MuiPaper-root-MuiAccordion-root.Mui-expanded': {
                        backgroundColor: "red"
                    }
                }} >
                    <AccordionSummary sx={{ width: "100%", display: 'flex', alignItems: "baseline" }} expandIcon={<Iconify icon="eva:arrow-ios-downward-fill" />}>
                        <Box sx={{ width: "100%" }} >
                        ...
                        <Box sx={{ p: 0 }} >
                            <Stack direction='column' gap={2} alignItems='center' justifyContent='space-between'>
                                ...
                                <Stack direction='row' justifyContent='space-between' alignItems='center' width={"100%"} >
                                    <Typography variant='caption' sx={{ fontWeight: 900 }}>Show Appbar</Typography>
                                    <Switch
                                        checked={appBar?.container?.show}
                                        onChange={(event: any, value: any) => handleChangeEvent('show', value, 'container')}
                                        inputProps={{ 'aria-label': 'controlled' }}
                                    />
                                </Stack>
                                <Stack direction='row' justifyContent='space-between' alignItems='center' width={"100%"} >
                                    <Typography variant='caption' sx={{ fontWeight: 900 }}>Shadow</Typography>
                                    <Switch
                    ...
                    <AccordionDetails>
                        <Box sx={{ p: 0 }} >
                            <Stack direction='column' gap={2} alignItems='start' justifyContent='space-between'>
                                ...
                                <LogoDealer themeConfig={{ logo: "", ...themeConfig }} builderId={builder_Id} handleThemeConfig={handleThemeConfig} />
                    ...
                    <AccordionDetails>
                        <Box sx={{ p: 0 }} >
                            <Stack direction='column' gap={2} alignItems='start' justifyContent='space-between'>
                                ...
                                <Box sx={{ width: "100%" }} >
                                    <Typography variant='caption' color='#8688A3'>Hover Color</Typography>
                                    <Stack direction='row' alignItems='center' spacing='18px'>
                                        <MuiColorInput sx={{ width: "100%", margin: "auto", }} variant="outlined"
                                            value={appBar?.logoObj?.textBg ?? "#000001"}
                                            format="hex"
                                ...
                                <Box sx={{ width: "100%", display: 'flex', gap: 2 }} >
                                    <Box>
                                        <Typography variant='caption' color='#8688A3'>Link</Typography>
                                        <Stack direction='row' alignItems='center' spacing='18px'>
                                            <Stack direction="row" alignItems="center" spacing={1} width={1}>
                                                <TextField variant='filled'
                                                    type='text'
                                    ...
                                    <Box>
                                        <Typography variant='caption' color='#8688A3'>Name</Typography>
                                        <Stack direction='row' alignItems='center' spacing='18px'>
                                            <Stack direction="row" alignItems="center" spacing={1} width={1}>
                                                <TextField variant='filled'
                                                    type='text'
                    ...
                    <AccordionDetails>
                        <Box sx={{ p: 0 }} >
                            ...
                            <Stack direction='column' gap={2} alignItems='center' justifyContent='space-between' >
                                ...
                                <Stack direction='row' justifyContent='space-between' alignItems='center' width={"100%"} >
                                    <Typography variant='caption' sx={{ fontWeight: 900 }}>Has Background</Typography>
                                    <Switch
                                        checked={appBar?.icon?.hasBackground}
                                        onChange={(event: any, value: any) => handleChangeEvent('hasBackground', value, 'icon')}
                                        inputProps={{ 'aria-label': 'controlled' }}
                                    />
                                </Stack>
